...
class CirqSimulator(QuantumSimulator):
    ...
    def get_expectation_values(self, circuit, qubit_operator, **kwargs):
        ...
        if self.n_samples == None:
            ...
            basis_change_circuit, ising_operator = get_context_selection_circuit(qubit_operator)
            final_circuit = circuit + basis_change_circuit
            measurements = self.run_circuit_and_measure(final_circuit)

        return measurements.get_expectation_values(ising_operator)
